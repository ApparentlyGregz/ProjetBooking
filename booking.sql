...
INSERT INTO `tarif` (`id`, `logement_id`, `prix_nuit`, `date_debut`, `date_fin`) VALUES
(1, 1, 250.00, '2025-06-01', '2025-08-31'),
(2, 2, 80.00, '2025-01-01', '2025-12-31'),
(3, 3, 150.00, '2025-01-01', '2025-03-31');
...
(4, 'testuser', 'testpass', 'test@example.com', 'Test', 'User', '0102030405', 'client', 0, '2025-04-15 11:59:59');
COMMIT;
