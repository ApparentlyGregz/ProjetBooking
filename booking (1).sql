...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 23 avr. 2025 à 13:59
...
(5, 'marin', '', 123, 123, 6, 1, 1, 1, 'lalala', '2025-04-16'),
(6, 'marin baise gregz', 'Hôtel', 2, 200000, 9, 1, 1, 1, 'le gros bg', '2025-04-17');
...
(11, 6, 'logement2_2.jpeg'),
(12, 6, 'logement2_3.jpeg'),
(13, 6, 'logement3_1.jpeg');
...
INSERT INTO `reservation` (`id`, `logement_id`, `utilisateur_id`, `date_debut`, `date_fin`, `nombre_adultes`, `nombre_enfants`, `statut`, `prix_total`, `promotion_id`, `date_reservation`) VALUES
(1, 1, 2, '2025-07-10', '2025-07-15', 2, 2, 'confirmée', 1062.50, 1, '2025-04-15 11:59:59'),
(2, 3, 3, '2025-02-10', '2025-02-15', 2, 0, 'en_attente', 675.00, 2, '2025-04-15 11:59:59');
